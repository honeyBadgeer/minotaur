...
const preloadSpines: Record<string, { json: string; atlas: string }> = {
  newbiePlayer: {
    json: 'assets/spines/newbie/skeleton.json',
    atlas: 'assets/spines/newbie/skeleton.atlas',
  },
  expertPlayer: {
    json: 'assets/spines/expert/skeleton.json',
    atlas: 'assets/spines/expert/skeleton.atlas',
  },
  masterPlayer: {
    json: 'assets/spines/master/skeleton.json',
    atlas: 'assets/spines/master/skeleton.atlas',
  },
  mouse: {
    json: 'assets/spines/animals/mouse/skeleton.json',
    atlas: 'assets/spines/animals/mouse/skeleton.atlas',
  },
  frog: {
    json: 'assets/spines/animals/frog/skeleton.json',
    atlas: 'assets/spines/animals/frog/skeleton.atlas',
  },
  turtle: {
    json: 'assets/spines/animals/turtle/skeleton.json',
    atlas: 'assets/spines/animals/turtle/skeleton.atlas',
  },
  bear: {
    json: 'assets/spines/animals/bear/skeleton.json',
    atlas: 'assets/spines/animals/bear/skeleton.atlas',
  },
  boar: {
    json: 'assets/spines/animals/boar/skeleton.json',
    atlas: 'assets/spines/animals/boar/skeleton.atlas',
  },
  bunny: {
    json: 'assets/spines/animals/bunny/skeleton.json',
    atlas: 'assets/spines/animals/bunny/skeleton.atlas',
  },
  deer: {
    json: 'assets/spines/animals/deer/skeleton.json',
    atlas: 'assets/spines/animals/deer/skeleton.atlas',
  },
  elephant: {
    json: 'assets/spines/animals/elephant/skeleton.json',
    atlas: 'assets/spines/animals/elephant/skeleton.atlas',
  },
  fox: {
    json: 'assets/spines/animals/fox/skeleton.json',
    atlas: 'assets/spines/animals/fox/skeleton.atlas',
  },
  horse: {
    json: 'assets/spines/animals/horse/skeleton.json',
    atlas: 'assets/spines/animals/horse/skeleton.atlas',
  },
  lion: {
    json: 'assets/spines/animals/lion/skeleton.json',
    atlas: 'assets/spines/animals/lion/skeleton.atlas',
  },
  monkey: {
    json: 'assets/spines/animals/monkey/skeleton.json',
    atlas: 'assets/spines/animals/monkey/skeleton.atlas',
  },
  monster: {
    json: 'assets/spines/animals/monster/skeleton.json',
    atlas: 'assets/spines/animals/monster/skeleton.atlas',
  },
  panther: {
    json: 'assets/spines/animals/panther/skeleton.json',
    atlas: 'assets/spines/animals/panther/skeleton.atlas',
  },
  ram: {
    json: 'assets/spines/animals/ram/skeleton.json',
    atlas: 'assets/spines/animals/ram/skeleton.atlas',
  },
  snake: {
    json: 'assets/spines/animals/snake/skeleton.json',
    atlas: 'assets/spines/animals/snake/skeleton.atlas',
  },
  squirrel: {
    json: 'assets/spines/animals/squirrel/skeleton.json',
    atlas: 'assets/spines/animals/squirrel/skeleton.atlas',
  },
  tiger: {
    json: 'assets/spines/animals/tiger/skeleton.json',
    atlas: 'assets/spines/animals/tiger/skeleton.atlas',
  },
  zebra: {
    json: 'assets/spines/animals/zebra/skeleton.json',
    atlas: 'assets/spines/animals/zebra/skeleton.atlas',
  },
  gun: {
    json: 'assets/spines/gun/skeleton.json',
    atlas: 'assets/spines/gun/skeleton.atlas',
  },
  sightPointer: {
    json: 'assets/spines/sight-pointer/skeleton.json',
    atlas: 'assets/spines/sight-pointer/skeleton.atlas',
  },
  baseBulletImpact: {
    json: 'assets/spines/bullet-impact/base/skeleton.json',
    atlas: 'assets/spines/bullet-impact/base/skeleton.atlas',
  },
  secondaryBulletImpact: {
    json: 'assets/spines/bullet-impact/secondary/skeleton.json',
    atlas: 'assets/spines/bullet-impact/secondary/skeleton.atlas',
  },
  thirdBulletImpact: {
    json: 'assets/spines/bullet-impact/third/skeleton.json',
    atlas: 'assets/spines/bullet-impact/third/skeleton.atlas',
  },
};
